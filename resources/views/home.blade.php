	...
	<div id="page">
		...
		<div id="colorlib-featured-product">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<a href="{{url('shop')}}" class="f-product-1" style="background-image: url(images/item-1.jpg);">
							<div class="desc">
					...
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-6">
								<a href="{{url('shop')}}" class="f-product-2" style="background-image: url(images/item-2.jpg);">
									<div class="desc">
							...
							<div class="col-md-6">
								<a href="{{url('shop')}}" class="f-product-2" style="background-image: url(images/item-4.jpg);">
									<div class="desc">
							...
							<div class="col-md-12">
								<a href="{{url('shop')}}" class="f-product-2" style="background-image: url(images/item-3.jpg);">
									<div class="desc">
